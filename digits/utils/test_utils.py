...
class TestParseVersion():
    ...
    def test_lt(self):
        ...
        example_lists = [
            ...
            (
                'v0.13.0 v0.13.1 v0.13.2 v0.14.0-alpha '
            ...
            '0.1 0.2 0.3 1.0 1.1'.split(),
            '1.1.0 1.1.1 1.1.2 1.2.0'.split(),
            '0.9 1.0a1 1.0a2 1.0b1 1.0rc1 1.0 1.1a1'.split(),
            '0.9 1.0.dev1 1.0.dev2 1.0.dev3 1.0.dev4 1.0c1 1.0c2 1.0 1.0.post1 1.1.dev1'.split(),
            '2012.1 2012.2 2012.3 2012.15 2013.1 2013.2'.split(),
        ]
